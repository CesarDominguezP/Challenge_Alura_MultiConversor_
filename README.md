# <h1> Challenge MultiConversor - Programa Alura/Oracle Next Education</h1>
...
El proyecto contiene un archivo en formato ejecutable ".jar". <h5>IMPORTANTE:</h5> el SE-java 15 para efecto del funcionamiento del mismo.
